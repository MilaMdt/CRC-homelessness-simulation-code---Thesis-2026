# no Hierarchy 4rth order AIC Chapman
...
colMeans(results[,c("n000", "est.pop.size")]) # 19,355.584
colSds(  as.matrix(results[,c("n000", "est.pop.size")]))/(MC^0.5) # 18.15

# clearly biased still
