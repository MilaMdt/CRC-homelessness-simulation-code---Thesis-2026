...
colMeans(results[,c("n00", "N_est_standard_cov")]) # 8015.25 vs 20067.77
colSds(  results[,c("n00", "N_est_standard_cov")])/(MC^0.5) # 41.8155 vs 42.10757
